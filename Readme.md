...
### 🧠 Smart LMS — AI-Adaptive Learning Platform
...
**Tech Stack:** `MERN` • `TypeScript` • `Google Gemini API`

---

### 🌍 Veltrio — Real-Time Communication Hub
Built a scalable communication application designed for seamless, real-time multilingual interactions and translation.

**Tech Stack:** `React` • `TypeScript` • `AI Translation Services`

---

### 🥽 ARgorithm — XR Visualization Suite
...
### 🏢 Hostel Management System — Role-Based Access Control Platform
