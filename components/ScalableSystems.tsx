...
const ScalableSystems: React.FC = () => {
  ...
  const [selectedProject, setSelectedProject] = useState(scalableProjects[0] || PROJECTS[0]);
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-black mb-6 tracking-tight flex flex-col md:flex-row items-center justify-center gap-4"
            style={{ color: '#0f172a' }}>
            Scalable Systems &amp; <span className="text-gradient uppercase tracking-tighter">Databases</span>
          </h2>
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-8 rounded-3xl relative overflow-hidden h-full flex flex-col justify-between"
              ...
              <div>
                <div className="flex justify-between items-center mb-6 pb-4" style={{ borderBottom: '1px solid rgba(99,102,241,0.10)' }}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-bold uppercase tracking-widest mt-0.5" style={{ color: '#94a3b8' }}>Database Query Optimization &amp; Complexity</p>
                    </div>
                  </div>
                ...
                {/* Pipeline Flow */}
                <h5 className="text-[10px] font-black uppercase tracking-widest mb-4" style={{ color: '#4f46e5' }}>Execution Thread Stages</h5>
