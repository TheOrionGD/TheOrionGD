...
import { FaGithub, FaExternalLinkAlt, FaBrain, FaTerminal, FaPlay, FaCheckCircle, FaMicrochip, FaFileAlt } from 'react-icons/fa';
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 max-w-7xl mx-auto">
          ...
          <div className="lg:col-span-5 flex flex-col gap-4">
            <div className="text-[10px] font-black uppercase tracking-widest px-2 mb-2 flex items-center gap-2" style={{ color: '#4f46e5' }}>
              <span className="w-2 h-2 rounded-full animate-ping" style={{ background: '#4f46e5' }}></span>
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-8 rounded-3xl relative overflow-hidden h-full flex flex-col justify-between"
              ...
              <div>
                <div className="flex justify-between items-center mb-6 pb-4" style={{ borderBottom: '1px solid rgba(99,102,241,0.10)' }}>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[9px] font-bold uppercase tracking-widest mt-0.5" style={{ color: '#94a3b8' }}>Model Blueprint &amp; Microservices</p>
                    </div>
                  </div>
                ...
                <h5 className="text-[10px] font-black uppercase tracking-widest mb-4" style={{ color: '#4f46e5' }}>Technical Pipeline Flow</h5>
