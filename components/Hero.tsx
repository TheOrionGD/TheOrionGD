...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center pt-16 pb-24 md:pt-16 md:pb-32 overflow-hidden w-full">
          ...
          >
            ...
            >
              <div className="relative flex h-2 w-2">
                <div className="animate-ping absolute inline-flex h-full w-full rounded-full opacity-75" style={{ background: '#22c55e' }}></div>
                <div className="relative inline-flex rounded-full h-2 w-2" style={{ background: '#22c55e', boxShadow: '0 0 8px rgba(34,197,94,0.8)' }}></div>
              </div>
              <span className="text-[10px] md:text-sm font-bold uppercase tracking-widest" style={{ color: '#4f46e5' }}>
            ...
            >
              <h2 className="text-xl md:text-3xl font-semibold tracking-tight">
                <span style={{ color: '#0f172a' }}>{prefixPart}</span>
                <span style={{ color: '#4f46e5' }}>{suffixPart}</span>
                <motion.span
                  animate={{ opacity: [1, 0] }}
                  transition={{
                    duration: 0.8,
            ...
            {/* Tagline */}
            <motion.div variants={itemVariants} className="max-w-xl mb-4">
              <p className="text-sm md:text-base leading-relaxed font-medium" style={{ color: '#64748b' }}>
                Building AI-integrated systems, immersive XR experiences, and scalable full-stack platforms.
            ...
            <motion.div variants={itemVariants} className="max-w-xl mb-10 space-y-6">
              <p className="text-base md:text-xl leading-relaxed mx-auto lg:mx-0" style={{ color: '#334155' }}>
              ...
              <div className="flex flex-wrap justify-center lg:justify-start gap-3.5 text-[10px] md:text-xs font-black uppercase tracking-wider">
                <span className="px-4 py-2 rounded-xl flex items-center gap-2 select-none"
                  style={{ background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.25)', color: '#4f46e5' }}>
                  <span className="w-1.5 h-1.5 rounded-full animate-ping shrink-0" style={{ background: '#4f46e5' }} />
                  B.E CSE
                </span>
                <span className="px-4 py-2 rounded-xl flex items-center gap-2 select-none"
                  style={{ background: 'rgba(99,102,241,0.08)', border: '1px solid rgba(99,102,241,0.25)', color: '#4f46e5' }}>
                ...
                <span className="px-4 py-2 rounded-xl flex items-center gap-2 select-none transition-colors"
                  style={{ background: 'rgba(15,23,42,0.04)', border: '1px solid rgba(15,23,42,0.10)', color: '#334155' }}>
                  <FaMapMarkerAlt className="animate-bounce" style={{ color: '#4f46e5' }} />
                  Tiruchirappalli
                </span>
              </div>
            </motion.div>
            ...
            >
              <a
                href="#projects"
                className="w-full sm:w-auto group relative px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-[0.2em] transition-all duration-300 hover:scale-105 overflow-hidden text-center text-white"
                style={{
              ...
              <a
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-[0.2em] transition-all duration-300 text-center"
                style={{
            ...
            >
              {SOCIAL_LINKS.map((link, idx) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="transition-all duration-300 flex items-center gap-3 text-xs font-black uppercase tracking-widest group"
                  style={{ color: '#64748b' }}
          ...
          >
            ...
            >
              ...
              <motion.div
                ...
                className="absolute inset-[-15%] rounded-full border-dashed"
              ...
              <motion.div
                ...
                style={{ border: '2px solid rgba(124,58,237,0.12)' }}
              />
                ...
                >
                  {['React', 'AI', 'SQL', 'Java', 'Unity', 'Python'].map((tech, index) => {
                    ...
                    return (
                      ...
                      >
                        <motion.div
                          className="w-full h-8 mt-0 flex items-center justify-center rounded-full text-[10px] md:text-xs font-black tracking-widest uppercase"
                          style={{
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 40px rgba(99,102,241,0.40)'
                }}
              />
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow: '0 0 50px rgba(99,102,241,0.20)'
                }}
              >
                <img
                ...
                {/* Scan-line overlay */}
                <motion.div
                  className="absolute inset-0 w-full h-[15%]"
                  style={{ background: 'linear-gradient(transparent 0%, rgba(99,102,241,0.12) 50%, transparent 100%)' }}
                  animate={{ top: ['-20%', '120%'] }}
              ...
              <motion.div
                className="absolute top-4 -left-6 sm:-left-8 md:-left-12 px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 rounded-xl flex items-center gap-2 z-40 pointer-events-none"
                style={{
                ...
                style2={{ transform: "translateZ(30px)" }}
              >
                <div className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full" style={{ background: '#4f46e5', boxShadow: '0 0 8px rgba(99,102,241,0.8)' }} />
                <span className="text-[8px] md:text-xs font-bold tracking-wider whitespace-nowrap uppercase" style={{ color: '#0f172a' }}>📍 Trichy, India</span>
              </motion.div>

              {/* Floating Badge: Degree */}
              <motion.div
                className="absolute bottom-12 -right-6 sm:-right-8 md:-right-12 px-2 py-1 sm:px-3 sm:py-1.5 md:px-4 md:py-2 rounded-xl flex items-center gap-2 z-40 pointer-events-none"
                style={{
                  background: 'rgba(255,255,255,0.92)',
                  border: '1px solid rgba(99,102,241,0.20)',
                  boxShadow: '0 4px 16px rgba(99,102,241,0.12)',
              ...
              >
                <div className="w-1.5 h-1.5 md:w-2 md:h-2 rounded-full" style={{ background: '#7c3aed', boxShadow: '0 0 8px rgba(124,58,237,0.8)' }} />
                <span className="text-[8px] md:text-xs font-bold tracking-wider whitespace-nowrap uppercase" style={{ color: '#0f172a' }}>B.Tech CSE '27</span>
              </motion.div>
